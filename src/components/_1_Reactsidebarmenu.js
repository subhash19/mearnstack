    ...
    <aside className="bd-sidebar">
      ...
      >
        <ul className="list-unstyled mb-0 py-3 pt-md-1">
          <li className="mb-1">
            <NavLink to="/react/introduction">Getting started</NavLink>
            <div>
              <ul className="list-unstyled fw-normal pb-1 small">
                ...
                <li>
                  <NavLink to="/react/installation">Installation</NavLink>
                </li>
                <li>
                  <NavLink to="/react/folder-structure">
                    Folder Structure
                  </NavLink>
                </li>
              </ul>
          ...
          <li className="mb-1">
            ...
            <div>
              <ul className="list-unstyled fw-normal pb-1 small">
                <li>
                  <NavLink to="/react/class-component">Class Component</NavLink>
                </li>
                <li>
                  <NavLink to="/react/function-component">
                    Function Component
                  </NavLink>
                </li>
              </ul>
