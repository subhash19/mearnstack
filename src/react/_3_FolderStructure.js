      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-9">
            ...
            <ul>
              <li>
                <strong>Node</strong>: you can install node from the node.org
                <br />
                for check node version: <code>node -v</code>
                <br />
                for check npm version: <code>npm -v</code>
                <br />
              </li>
              <li>
            ...
            <p>
              if you've not need to app name and you need same folder name with
              react app then you can use this command
            </p>
